      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.headerSection}>
          <Animatable.Image
            ...
            style={styles.logo}
          />
          <Animatable.Text animation="fadeInDown" style={[styles.brandName, { color: colors.text }]}>
            Reset Password
          </Animatable.Text>
        ...
        <Animatable.View animation="fadeInUp" duration={800} delay={200} style={styles.formCard}>
          ...
          >
            <Text style={[styles.footerText, { color: colors.subtext }]}>
              Remembered it? <Text style={{ color: colors.primary, fontWeight: "700" }}>Back to Login</Text>
            </Text>
          </TouchableOpacity>
        </Animatable.View>
      </ScrollView>
