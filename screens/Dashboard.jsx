...
export default function Dashboard({ navigation }) {
  ...
  // All 6 core features, clearly grouped by direction
  const features = [
    {
...
const styles = StyleSheet.create({
  ...
  sectionHeader: { marginTop: 25, flexDirection: "row", justifyContent: "space-between", alignItems: "flex-end" },
  ...
  tipCard: { marginTop: 30, padding: 20, borderRadius: 20, borderWidth: 1, flexDirection: "row", alignItems: "flex-start" },
